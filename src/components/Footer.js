...
const Footer = () => {
    return (
        <div className='landing-footer bg-black text-white mt-20 py-28 px-5 md:px-[10%]'>
            <div className='landing-top flex flex-col sm:flex-row justify-between items-center py-20 mb-5 border-b-2 border-gray-100'>
                <div className='landing-top-left text-4xl flex-1 font-semibold text-center sm:text-left'>Get your AI app built with<br></br>blazing speed.</div>
            ...
            <div className='footer-bottom flex flex-col sm:flex-row justify-center items-center py-10 text-gray-300'>
                <div className='footer-bottom-left sm:flex-1'>
                ...
                <div className='footer-bottom-right flex flex-row justify-between items-center sm:flex-1 sm:mt-0 mt-10 w-[90%]'>
